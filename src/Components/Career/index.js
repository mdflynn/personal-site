    ...
    <section className="about-container">
        ...
        <div className="text-container">
          ...
          <div className="overlay">
            <div className="about-p">
              After I graduated UNC, I spent a few months selling Hyundais
      ...
      <section className="about-odd">
        <div className="text-container">
          ...
          <div className="overlay">
            <div className="about-p">
              After I spent roughly three years working for Wells Fargo at
      ...
      <section className="about-even">
        <div className="text-container">
          ...
          <div className="overlay">
            <div className="about-p">
              After I came back from Europe, I spent some time worker as a
      ...
      <section className="about-odd">
        <div className="text-container">
          ...
          <div className="overlay">
            <div className="about-p">
              After my MBA, I worked at Intrado for three years. A company
        ...
        <div className="text-container">
          ...
          <div className="overlay">
            <div className="about-p">
              ...
              great position and opportunity. I was responsible for accounts in
              five states in the PNW region. I was on the road most days of the
              week meeting clients and discussing their needs. I was also
              attending trade shows and demonstrating our products. However, I
              quickly found out, that this wasn't the right fit for me. I did
              not enjoy the traveling lifestyle like I initially anticipated.
              There's something to be said for sleeping in your own bed! I
              decided to take a break from a career oriented job and drove for
              Uber and Lyft for about a year and a half. It was a little awkward
              at first, but I grew to love the freedom it afforded me and I was
        ...
        <div className="text-container">
          ...
          <div className="overlay">
            <div className="about-p">
              ...
              management department at FirstBank. I was responsible for a team
              of nine employees that focused on phone based customer service and
              account management to our treasury management customers. I was
              responsible for interviewing and hiring new members on my team as
              well as creating training plans and having one on ones to review
      ...
      <section className="about-even">
        <div className="text-container">
          ...
          <div className="overlay">
            <div className="about-p">
              I've been thinking about coding for the better part of three
