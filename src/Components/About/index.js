...
import continued from "../../assets/tobecontinued.jpg";
  ...
  return (
    <section className="about-container">
      <section className="about-even">
        ...
        <div className="text-container">
          <p className="about-even-p">
            ...
            <br />
            <br />
            After I graduated UNC, I spent a few months selling Hyundais before
            I found my first career oriented job. I started off at Wells Fargo
            Financial. I spent a year commuting back and forth from Fort
            Collins, CO to Cheyenne, WY. During this role, I focused on
            generating appointments and leads in order to offer a customer a
            wide range of credit offerings. I received a District Employee of
            the Month award for the success I was having in the role. I
            transferred over to the banking side eventually, working my way up
            from a teller to a personal banker. I consistently met and surpassed
      ...
      <section className="about-odd">
        <div className="odd-div">
          <p className="about-odd-p">
            ...
            career was shaping up. I didn't feel strongly about my job and that
            it would bring my the type of challenges I was looking for. I ended
            up quitting, casing out my 401(k) plan and moving Prague, Czech
            Republic to get certified in Teaching English as a Foreign Language
            (TEFL). Due to Eyjafjallajökull in Iceland erupting right when we
            were supposed to fly to Europe, this trip only lasted four months. I
            was able to earn my certification, do a bit of teaching, and explore
            central and eastern Europe. It was a life-changing experience
          </p>
          <img className="arrow left-arrow" src={leftArrow} alt="left arrow" />
        </div>
      ...
      <section className="about-even">
        ...
        <div>
          <p className="about-even-p">
            ...
            CO. I needed to kill some time before I went to my MBA program in
            the following summer. It was a season with heavy snow and great
            runs. It was an amazing experience, both on the mountain and in the
            community. During that time, I was able to campaign and win the
            title of Steamboat's Most Eligible Bachelor; my crowning
      ...
      <section className="about-odd">
        <div className="odd-div">
          <p className="about-odd-p">
            ...
            up to a Senior Implementation Specialist. I handle projects that
            ranged in size and focused on implementing and decommissioning
            cellular site's 911 data and routing. Ensuring that 911 calls were
            properly routed to the nearest PSAP (Public Safety Answering Point).
          </p>
          <img className="arrow left-arrow" src={leftArrow} alt="left arrow" />
        </div>
      ...
      <section className="about-even">
        ...
        <div>
          <p className="about-even-p">
            ...
            quickly found out, that this wasn't the right fit for me. I did not
            enjoy the traveling lifestyle like I initially anticipated. There's
            something to be said for sleeping in your own bed! I decided to take
            a break from a career oriented job and drove for Uber and Lyft for
            about a year and a half. It was a little awkward at first, but I
      ...
      <section className="about-even">
        ...
        <img className="continued" src={continued} alt="to be continued" />
        </div>
      </section>
